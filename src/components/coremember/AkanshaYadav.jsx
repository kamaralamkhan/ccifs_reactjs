...
const AkanshaYadav = () => {
  return (
    <article className="flex flex-col md:flex-row bg-gray-900 text-white p-8 md:px-20 lg:px-32 space-y-6 md:space-y-0 md:space-x-12 rounded-lg shadow-lg">
      {/* Left container for image and designation */}
      <div className="flex-shrink-0 text-center md:text-left">
        <img
          src={akanshaImage}
          alt="Akansha Yadav - Forensic Associate at CCIFS"
          className="w-40 h-40 rounded-full border-4 border-blue-500 object-cover mx-auto md:mx-0"
          loading="lazy"
        />
        <h1 className="mt-4 text-xl font-bold">Akansha Yadav</h1>
      ...
      <div className="flex-grow">
        ...
        <section className="text-gray-300 text-sm leading-relaxed space-y-4 text-justify">
          <p>
